...
<div className="not-prose mt-12 pt-8 border-t border-[#30363d]">
  <p className="text-sm text-gray-400 mb-6">
    Previously:{" "}
    <a
      href="https://ryanskinner.com/posts/how-i-built-a-full-stack-react-framework-4x-faster-than-nextjs-with-4x-more-throughput"
      target="_blank"
      rel="noopener noreferrer"
      className="text-[#fd7e14] hover:text-[#e8590c] hover:underline"
    >
      How I Built a Full-Stack React Framework 4x Faster Than Next.js
    </a>{" "}
    and{" "}
    <a
      href="https://ryanskinner.com/posts/the-rari-ssr-breakthrough-12x-faster-10x-higher-throughput-than-nextjs"
      target="_blank"
      rel="noopener noreferrer"
      className="text-[#fd7e14] hover:text-[#e8590c] hover:underline"
    >
      The rari SSR Breakthrough: 12x Faster, 10x Higher Throughput
    </a>
    .
  </p>
  <div className="flex flex-wrap items-center gap-3">
    <a
      ...
      className="inline-flex items-center px-4 py-2 bg-[#fd7e14] !text-gray-900 text-sm font-medium rounded-md hover:bg-[#e8590c] transition-colors"
    >
      Get Started
    </a>
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="inline-flex items-center px-4 py-2 bg-[#161b22] border border-[#30363d] !text-gray-300 text-sm font-medium rounded-md hover:border-[#fd7e14] hover:!text-[#f0f6fc] transition-colors"
    >
      GitHub
    </a>
    <a
