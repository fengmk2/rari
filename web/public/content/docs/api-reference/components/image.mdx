...
export const description =
  "Optimize and serve images with automatic format conversion, responsive sizing, and lazy loading using the rari Image component.";

<PageHeader title="Image Component" />
