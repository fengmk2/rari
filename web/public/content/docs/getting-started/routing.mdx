...
export const description =
  "Learn how file-based routing works in rari. Pages, layouts, dynamic segments, loading states, error boundaries, and not-found handling.";
...
<CodeBlock filename="src/app/api/users/[id]/route.ts" language="typescript">{`import type { RouteHandler } from 'rari'
