...
export const description =
  "Connect to databases in rari using Server Components and Server Actions. Learn how to use Neon Postgres and other databases with rari's high-performance Rust runtime.";
...
1. Create a Neon account at [neon.com](https://get.neon.com/KDQudHN)
