...
export const description =
  "Learn how navigation works in rari using standard HTML anchor tags with automatic client-side routing, plus programmatic navigation via the navigate function and useRouter hook.";
...
<CodeBlock
  filename="src/app/components/Navigation.tsx"
  language="tsx"
...
- **`useRouter()`**: for components that need to navigate _and_ read route state.
