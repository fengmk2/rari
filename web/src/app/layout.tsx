...
export default function RootLayout({ children, pathname }: LayoutProps) {
  return (
    <Providers pathname={pathname}>
      <div
        className="min-h-screen bg-[#30363d] text-gray-200 font-sans overflow-x-hidden"
        style={{ "--sidebar-width": "calc(8rem)" } as React.CSSProperties}
      >
...
export const metadata: Metadata = {
  ...
  themeColor: [{ color: "#0d1117" }, { media: "(prefers-color-scheme: dark)", color: "#0d1117" }],
  appleWebApp: {
