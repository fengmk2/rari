...
export interface RequestCookies {
  ...
  set: ((name: string, value: string, options?: CookieOptions) => void) &
    ((options: { name: string; value: string } & CookieOptions) => void);
}
...
export type ProxyFunction = (request: any, event?: RariFetchEvent) => Promise<any> | any;
...
export type ProxyRuleCondition = ProxyCondition | { type: "host"; key: string; value?: string };
