...
export function resolveWithExtensions(resolvedPath: string, extensions: string[]): string | null {
...
export function resolveIndexFile(resolvedPath: string, extensions: string[]): string | null {
