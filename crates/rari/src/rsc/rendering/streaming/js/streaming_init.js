...
if (typeof React === "undefined")
  throw new TypeError(
    "React is not available in streaming context. This suggests the runtime was not properly initialized with React extensions.",
  );
...
globalThis["~suspense"].safeSerializeElement = function (element) {
  ...
  try {
    ...
    if (element && typeof element === "object") {
      ...
      if (element.props) {
        if (element.props.children !== undefined) {
          ...
          if (children === null || children === undefined) {
            ...
            safeProps.children = children.map((child) =>
              globalThis["~suspense"].safeSerializeElement(child),
            );
      ...
      return {
        type:
          typeof element.type === "function" ? element.type.name || "div" : element.type || "div",
        props: safeProps,
        key: null,
      };
    }
