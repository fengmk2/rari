  ...
  if (typeof React === "undefined") {
    try {
      if (typeof globalThis["~rsc"]?.modules !== "undefined") {
        ...
        if (reactModule) globalThis.React = reactModule;
      }
      ...
      if (typeof React !== "undefined" && React.Suspense) {
        ...
        React.Suspense = function SuspenseOverride(props) {
          ...
          try {
            ...
            if (!props.children) return safeFallback;
            ...
            if (error && error.$$typeof === REACT_SUSPENSE_PENDING && error.promise) {
              ...
              if (!globalThis["~suspense"].promises) globalThis["~suspense"].promises = {};
              ...
              globalThis["~suspense"].pendingPromises.push({
                id: promiseId,
                boundaryId,
                componentPath: error.componentName || "unknown",
              });
