...
if (typeof globalThis.renderToRsc === "undefined") {
  throw new TypeError("renderToRsc not initialized - rsc_traversal.js may have failed to load");
}
...
if (!globalThis["~rsc"].rendererInitialized) {
  ...
  globalThis["~rsc"].componentRenders = globalThis["~rsc"].componentRenders || new Map();
