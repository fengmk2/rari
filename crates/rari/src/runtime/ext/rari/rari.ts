...
const nonEnumerable = (value: unknown): PropertyDescriptor =>
  ObjectProperties.apply(value, "nonEnumerable");
const readOnly = (value: unknown): PropertyDescriptor => ObjectProperties.apply(value, "readOnly");
const writeable = (value: unknown): PropertyDescriptor =>
  ObjectProperties.apply(value, "writeable");
...
const applyToGlobal = (properties: PropertyDescriptorMap) =>
  Object.defineProperties(globalThis, properties);
const applyToDeno = (properties: PropertyDescriptorMap) =>
  Object.defineProperties(globalThis.Deno, properties);

export { applyToDeno, applyToGlobal, getterOnly, nonEnumerable, readOnly, writeable };
