...
if (typeof globalThis.React === "undefined") {
  globalThis.React = {
    createElement(type, props, ...children) {
      ...
      if (children && children.length > 0) normalizedChildren = children;
      else if (props && Object.hasOwn(props || {}, "children")) normalizedChildren = props.children;
      else normalizedChildren = undefined;
      ...
      return {
        ...
        key: props && Object.hasOwn(props, "key") ? props.key : null,
      };
    },
    ...
    cache(fn) {
      const hasOps =
        typeof Deno?.core?.ops?.op_cache_get === "function" &&
