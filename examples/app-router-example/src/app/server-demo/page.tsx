  ...
  return (
    <div className="bg-white rounded-xl p-12 shadow-2xl">
      <div className="bg-white p-8 rounded-xl mb-8 border border-gray-200 shadow-sm">
        <h1 className="text-4xl font-bold mb-2 text-gray-900">Server Components Demo</h1>
      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
        <h2 className="text-xl font-semibold mb-4 text-gray-800">How Server Components Work</h2>
