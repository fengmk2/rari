  ...
  return (
    <div className="grid gap-8">
      <div className="bg-white rounded-xl p-12 shadow-2xl">
        <h1 className="text-4xl font-bold mb-4 text-gray-900">Interactive Components Test</h1>
        <p className="text-lg text-gray-600 mb-8">
          This page demonstrates mixing server and client components using RSC. The components below
          are client-side React components that maintain state.
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl p-8 shadow-2xl">
        ...
        <p className="text-gray-600 leading-relaxed mt-4">
          Try refreshing the page - the timestamp will update (server-rendered), but the counter and
          todo state will reset (client-rendered).
        </p>
      </div>
    </div>
  );
